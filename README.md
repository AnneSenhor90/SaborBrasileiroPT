...
- tornar o login com Google a entrada principal;
- manter opção alternativa para criar conta sem Google;
...
## Upgrade planejado: login com Google

A próxima evolução recomendada é priorizar o login com conta Google.
